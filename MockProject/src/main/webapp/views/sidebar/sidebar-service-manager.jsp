...
<body>
	<div class="float-left sidebar vh-100 border-right bg-light">
        <ul class="list-unstyled">
            <li class="border-bottom p-3"><a href="#"><i class="fas fa-tachometer-alt mr-2"></i>Car park manager</a>
            </li>
            <li class="p-3 border-bottom">
                <details>
                    <summary style="list-style: none; color: #007bff;">
                        <i class="fas fa-car mr-2"></i>Car manager<i class="fas fa-chevron-down float-right"
                            style="line-height: 24px;"></i>
                    </summary>
                    <a id="carList" href="car-list.jsp" class="d-block ml-1 border-bottom p-3"><i
            ...
            <li class="p-3 border-bottom">
                <details>
                    ...
                    <a id="bookingOfficeList" href="booking-office-list.jsp" class="d-block ml-1 border-bottom p-3"><i
                            class="fas fa-list-ul mr-2"></i>Booking office list</a>
                    <a id="addBookingOffice" href="add-booking-office.jsp" class="d-block ml-1 p-3"><i
            ...
            <li class="p-3 border-bottom">
                <details>
                    ...
                    <a id="parkingLotList" href="parking-lot-list.jsp" class="d-block ml-1 border-bottom p-3"><i
                            class="fas fa-list-ul mr-2"></i>Parking lot list</a>
                    <a id="addParkingLot" href="add-parking-lot.jsp" class="d-block ml-1 p-3"><i
            ...
            <li class="p-3 border-bottom">
                <details>
                    <summary style="list-style: none; color: #007bff;">
                        <i class="fas fa-ticket-alt mr-2" style="transform: rotate(-45deg);"></i>Ticket manager<i
                            class="fas fa-chevron-down float-right" style="line-height: 24px;"></i>
                    </summary>
                    <a id="bookingOfficeList" href="ticket-list.jsp" class="d-block ml-1 border-bottom p-3"><i
                            class="fas fa-list-ul mr-2"></i>Ticket list</a>
                    <a id="addBookingOffice" href="add-ticket.jsp" class="d-block ml-1 p-3"><i
