...
<form action="" class="float-left main-content border-top">
            <h2 class="m-4">Add Ticket</h2>
            <hr class="m-4">
            <table class="m-4">
                <tr>
                    <td class="font-weight-bold pr-5 pt-2 pb-2">Customer <label class="required">(*)</label></td>
                    <td><input class="box form-control pt-2 pb-2 text-sm" placeholder="Enter customer name" type="text"
                            name="customer-name" id="customer-name" required></td>
                </tr>
                <tr>
                    <td class="font-weight-bold pr-5 pt-2 pb-2">Booking Time <label class="required">(*)</label></td>
                    <td><input class="box form-control pt-2 pb-2 text-sm" type="time"
                            name="booking-time" id="booking-time" required></td>
                </tr>
                <tr>
            ...
            <div class="d-flex list-btn">
                ...
                <div onclick="clickReset()" class="btn btn-warning mr-1 text-btn"><i class="fas fa-redo mr-1"
                    style="transform: scaleX(-1);"></i>Reset</div>
