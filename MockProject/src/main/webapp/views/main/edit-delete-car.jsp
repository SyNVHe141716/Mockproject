					...
					<td><select name="parkingLot"
						class="box form-control pt-2 pb-2 text-sm">
							...
							<c:forEach items="${listp}" var="p">
								<option value="${p.id}" ${p.id==listlp.packId?"selected":""}>${p.name}</option>
							</c:forEach>
					</select></td>
				</tr>
			</table>
